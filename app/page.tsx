  ...
  <>
    <div
      style={{
        ...
        inset: 0,
        background:
          "linear-gradient(135deg,#0a0a0f 0%,#0d1117 40%,#0a1628 100%)",
        zIndex: -2,
      }}
    />
    <div
      style={{
        ...
        borderRadius: "50%",
        background:
          "radial-gradient(circle,rgba(0,212,200,.07) 0%,transparent 70%)",
        filter: "blur(40px)",
        pointerEvents: "none",
        zIndex: -1,
      }}
    ...
    <div
      style={{
        ...
        borderRadius: "50%",
        background:
          "radial-gradient(circle,rgba(0,150,255,.06) 0%,transparent 70%)",
        filter: "blur(50px)",
        pointerEvents: "none",
        zIndex: -1,
      }}
...
const PokemonCorners = () => (
  <>
    {[
      {
        name: "squirtle",
        pos: { bottom: 16, left: 24 },
        color: "rgba(0,212,200,.5)",
        label: "SQUIRTLE",
      },
      {
        name: "pikachu",
        pos: { bottom: 16, right: 24 },
        color: "rgba(255,220,0,.5)",
        label: "PIKACHU",
      },
      {
        name: "snorlax",
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <div
          style={{
            ...
            borderRadius: 10,
            background:
              "linear-gradient(135deg,rgba(0,212,200,.2),rgba(0,150,255,.2))",
        ...
        >
          <img
            src="https://play.pokemonshowdown.com/sprites/ani/bulbasaur.gif"
            alt="Bulbasaur"
    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 25px 50px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.06)",
          padding: "2.5rem",
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          >
            <img
              ...
              style={{
                width: 52,
                imageRendering: "pixelated",
                filter: "drop-shadow(0 0 4px rgba(0,212,200,.6))",
              }}
            />
          </div>
          <h1
          ...
          <p style={{ fontSize: 13, color: "rgba(255,255,255,.35)" }}>
            {mode === "login"
              ...
              : "Regístrate y guarda tus puntajes"}
          </p>
        </div>
        {/* Form */}
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          {mode === "register" && (
            <div>
              <label className="ql">Username</label>
              <input
                className="qi"
                type="text"
          ...
          <div>
            <label className="ql">Contraseña</label>
            <input
              className="qi"
              type="password"
              placeholder="••••••••"
          ...
          >
            {isLoading ? (
              ...
              <>
                <LogIn style={{ width: 16, height: 16 }} /> Iniciar Sesión
              </>
            ) : (
              <>
          ...
          <button
            ...
            onMouseOver={(e) =>
              (e.currentTarget.style.color = "rgba(0,212,200,.8)")
            }
            onMouseOut={(e) =>
...
function DashboardView({
  ...
  usuario: Usuario;
  onLogout: () => void;
  onStartQuiz: (topic: string, questions: QuizQuestion[]) => void;
}) {
  ...
  useEffect(() => {
    fetch(`/api/puntajes?usuarioId=${usuario.id}`)
      .then((r) => r.json())
      .then((d) => setHistorial(d.puntajes ?? []))
      .catch(() => {});
  }, [usuario.id]);
  ...
  return (
    ...
    >
      ...
      <Header
        usuario={usuario}
        onLogout={onLogout}
        onHistorial={() => setShowHistorial(!showHistorial)}
                  ...
                  >
                    ...
                    <div style={{ textAlign: "right" }}>
                      ...
                      <p
                        style={{ color: "rgba(255,255,255,.3)", fontSize: 11 }}
                      >
                        {p.correctas}/{p.totalPregs} correctas
                      </p>
                    </div>
                  </div>
                ))}
    ...
    >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              >
                <img
                  src="https://play.pokemonshowdown.com/sprites/ani/bulbasaur.gif"
                  alt=""
                  style={{ width: 26, imageRendering: "pixelated" }}
                />
              </div>
              <span
                style={{
          ...
          >
            <div
              style={{
                height: "100%",
                width: `${progress}%`,
                background: "linear-gradient(90deg,#00d4c8,#0096ff)",
                borderRadius: 4,
          ...
          {q.options.map((opt, i) => (
            ...
            >
              <div className="opt-dot">
                {selected === i && <div className="opt-dot-inner" />}
              </div>
              <span>{opt}</span>
            </button>
          ))}
      ...
      >
        ...
        >
          <button
            className="qb"
            style={{ width: "auto", paddingLeft: 28, paddingRight: 28, gap: 8 }}
            onClick={handleNext}
...
function ResultsView({
  ...
  const sc =
    score >= 80
      ? { color: "#10b981", label: "¡Excelente trabajo!", emoji: "🏆" }
      : score >= 60
        ? { color: "#f59e0b", label: "¡Buen esfuerzo!", emoji: "⭐" }
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: "rgba(0,212,200,.7)" }}>{topic}</span>
          </div>
          {saved && (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <button className="qb" onClick={onNewQuiz}>
              <RotateCcw style={{ width: 16, height: 16 }} /> Crear nuevo examen
            </button>
